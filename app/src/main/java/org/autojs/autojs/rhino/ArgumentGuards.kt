...
open class ArgumentGuards {
    ...
    companion object {
        ...
        fun <R> ensureArgumentsNotEmpty(args: Array<out Any?>, function: (arrayArgs: Array<Any?>) -> R): R {
            ...
            throw WrappedIllegalArgumentException(context.getString(com.xiaoyu.ai.R.string.error_arguments_cannot_be_empty))
        }

        fun <R> ensureArgumentsIsEmpty(args: Array<out Any?>, function: () -> R): R {
            if (args.isEmpty()) return function.invoke()
            throw WrappedIllegalArgumentException(context.getString(com.xiaoyu.ai.R.string.error_arguments_must_be_empty))
        }
        ...
        fun <R> ensureArgumentsOnlyOne(args: Array<out Any?>, preventUnwrapped: Boolean, function: (singleArg: Any?) -> R): R {
            return when {
                args.isEmpty() -> throw WrappedIllegalArgumentException(context.getString(com.xiaoyu.ai.R.string.error_arguments_cannot_be_empty))
                args.size > 1 -> throw WrappedIllegalArgumentException(resources.getQuantityString(com.xiaoyu.ai.R.plurals.error_method_only_accepts_n_arguments, 1, 1))
        ...
        fun <R> ensureArgumentsAtLeast(args: Array<out Any?>, n: Int, function: (arrayArgs: Array<Any?>) -> R): R {
            ...
            throw WrappedIllegalArgumentException(resources.getQuantityString(com.xiaoyu.ai.R.plurals.error_method_only_accepts_no_less_than_n_arguments, n, n))
        }

        fun <R> ensureArgumentsAtMost(args: Array<out Any?>, n: Int, function: (arrayArgs: Array<Any?>) -> R): R {
            if (args.size <= n) return unwrapAndInvokeAll(args, function)
            throw WrappedIllegalArgumentException(resources.getQuantityString(com.xiaoyu.ai.R.plurals.error_method_only_accepts_no_more_than_n_arguments, n, n))
        }

        fun <R> ensureArgumentsLength(args: Array<out Any?>, n: Int, function: (arrayArgs: Array<Any?>) -> R): R {
            if (args.size == n) return unwrapAndInvokeAll(args, function)
            throw WrappedIllegalArgumentException(resources.getQuantityString(com.xiaoyu.ai.R.plurals.error_method_only_accepts_n_arguments, n, n))
        }
        ...
        fun <R> ensureArgumentsLengthInRange(args: Array<out Any?>, range: IntRange, function: (arrayArgs: Array<Any?>) -> R): R {
            ...
            throw WrappedIllegalArgumentException(context.getString(com.xiaoyu.ai.R.string.error_method_only_accepts_a_number_of_arguments_in_the_range_n_to_m, min, max))
        }
